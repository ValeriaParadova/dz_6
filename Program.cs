...
Console.Write($"Enter number(amount of numbers): ");
...
void InputCoefficients(){
  ...
  {
    Console.Write($"Enter coeff {i+1}-го уравнения (y = k * x + b):\n");
    for (int j = 0; j < coeff.GetLength(1); j++)
    {
      if(j==0) Console.Write($"Enter coeff k: ");
      else Console.Write($"Enter coeff b: ");
